...
/* harmony import */ var _id3v2_AbstractID3Parser_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../id3v2/AbstractID3Parser.js */ "./node_modules/music-metadata/lib/id3v2/AbstractID3Parser.js");
/* harmony import */ var _XingTag_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./XingTag.js */ "./node_modules/music-metadata/lib/mpeg/XingTag.js");
...
class MpegContentError extends (0,_ParseError_js__WEBPACK_IMPORTED_MODULE_3__.makeUnexpectedFileContentError)('MPEG') {
}
/**
...
class MpegFrameHeader {
    constructor(buf, off) {
        ...
        this.versionIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 1, 3, 2);
        // C(18,17): Layer description
        this.layer = MpegFrameHeader.LayerDescription[_common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 1, 5, 2)];
        ...
        this.isProtectedByCRC = !_common_Util_js__WEBPACK_IMPORTED_MODULE_4__.isBitSet(buf, off + 1, 7);
    }
    ...
    parseMpegHeader(buf, off) {
        this.container = 'MPEG';
        // E(15,12): Bitrate index
        this.bitrateIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 2, 0, 4);
        // F(11,10): Sampling rate frequency index
        this.sampRateFreqIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 2, 4, 2);
        // G(9): Padding bit
        this.padding = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.isBitSet(buf, off + 2, 6);
        // H(8): Private bit
        this.privateBit = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.isBitSet(buf, off + 2, 7);
        // I(7,6): Channel Mode
        this.channelModeIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 3, 0, 2);
        // J(5,4): Mode extension (Only used in Joint stereo)
        this.modeExtension = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 3, 2, 2);
        // K(3): Copyright
        this.isCopyrighted = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.isBitSet(buf, off + 3, 4);
        // L(2): Original
        this.isOriginalMedia = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.isBitSet(buf, off + 3, 5);
        // M(3): The original bit indicates, if it is set, that the frame is located on its original media.
        this.emphasis = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 3, 7, 2);
    ...
    parseAdtsHeader(buf, off) {
        ...
        const profileIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 2, 0, 2);
        this.codec = 'AAC';
        this.codecProfile = MPEG4.AudioObjectTypes[profileIndex];
        debug(`MPEG-4 audio-codec=${this.codec}`);
        const samplingFrequencyIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 2, 2, 4);
        this.samplingRate = MPEG4.SamplingFrequencies[samplingFrequencyIndex];
        debug(`sampling-rate=${this.samplingRate}`);
        const channelIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 2, 7, 3);
        this.mp4ChannelConfig = MPEG4_ChannelConfigurations[channelIndex];
        debug(`channel-config=${this.mp4ChannelConfig ? this.mp4ChannelConfig.join('+') : '?'}`);
        this.frameLength = _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, off + 3, 6, 2) << 11;
    }
    calcBitrate() {
...
class MpegParser extends _id3v2_AbstractID3Parser_js__WEBPACK_IMPORTED_MODULE_5__.AbstractID3Parser {
    constructor() {
        super(...arguments);
        this.frameCount = 0;
    ...
    async parseAdts(header) {
        ...
        header.frameLength += _common_Util_js__WEBPACK_IMPORTED_MODULE_4__.getBitAllignedNumber(buf, 0, 0, 11);
    ...
    async readXtraInfoHeader() {
        const headerTag = await this.tokenizer.readToken(_XingTag_js__WEBPACK_IMPORTED_MODULE_6__.InfoTagHeaderTag);
        this.offset += _XingTag_js__WEBPACK_IMPORTED_MODULE_6__.InfoTagHeaderTag.len; // 12
        switch (headerTag) {
            case 'Info':
                this.metadata.setFormat('codecProfile', 'CBR');
            ...
            case 'Xtra':
                ...
                break;
            case 'LAME': {
                const version = await this.tokenizer.readToken(_XingTag_js__WEBPACK_IMPORTED_MODULE_6__.LameEncoderVersion);
                if (this.frame_size !== null && this.frame_size >= this.offset + _XingTag_js__WEBPACK_IMPORTED_MODULE_6__.LameEncoderVersion.len) {
                    this.offset += _XingTag_js__WEBPACK_IMPORTED_MODULE_6__.LameEncoderVersion.len;
    ...
    async readXingInfoHeader() {
        ...
        const infoTag = await (0,_XingTag_js__WEBPACK_IMPORTED_MODULE_6__.readXingHeader)(this.tokenizer);
        this.offset += this.tokenizer.position - offset;
        if (infoTag.lame) {
            this.metadata.setFormat('tool', `LAME ${_common_Util_js__WEBPACK_IMPORTED_MODULE_4__.stripNulls(infoTag.lame.version)}`);
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_mpeg_MpegParser_js.7e42dbf99fdcadb3636b.js.map